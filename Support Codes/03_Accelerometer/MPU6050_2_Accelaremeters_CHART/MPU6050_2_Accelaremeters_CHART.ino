...
//----------------------------------------------\user defined functions\-------------------------------------------------- 
 ...
 void GetMpuValue1(const int MPU){ 
  ...
  //    Serial.print("AcX = ");
      Serial.print(AcX1/16384+0.06);
      Serial.print(","); 
      Serial.print(AcY1/16384-0.02);
      Serial.print(",");
      Serial.print((AcZ1/16384)-0.18); 
 //     Serial.print(",");
   //   Serial.print(GyX1/131); 
   //   Serial.print(" | GyY = "); 
   //   Serial.print(GyY1/131);
 //     Serial.print(" | GyZ = ");
